...
//        int channels = bridge.getAudioChannels(videoCtx);
//
//        if (sampleRate > 0 && channels > 0) {
//            try {
//                // Configuração PCM S16 Estéreo conforme definido em sua biblioteca C (swr_alloc_set_opts2)
...
//        isSeeking = false;
//
//        // Decodifica um frame imediatamente para atualizar a imagem de forma estática
...
//            } else {
//                // Converte escala linear de volume (0-1) para Decibéis (dB)
